...
<table border="0" cellspacing="0" cellpadding="0"   class="data-table">
 ...
 <tr>
    ...
    <td></td>
    <td align="right"><strong> $4,600.36 </strong> </td>
    <td align="right"><strong> $4,600.36 </strong> </td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="2"><table border="0" cellspacing="0" cellpadding="0" width="100%" class="total-amount-table">
            <tr>
				...
				<td align="right" width="50%" bgcolor="#ebebeb"> $4,940.36 &nbsp;</td>
            </tr>
            <tr>
                <td align="right" width="50%">(GST) &nbsp;</td>
				<td align="right" width="50%" bgcolor="#ebebeb"> $494.84 &nbsp;</td>
            </tr>
            <tr>
                <td align="right" width="50%"> Total &nbsp;</td>
				<td align="right" width="50%" bgcolor="#ebebeb"> $5,443.19 &nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
				...
				<td align="right" width="50%" bgcolor="#ebebeb"> <strong>$5,443.19</strong> &nbsp;</td>
            </tr>
        </table>
    </td>
  </tr>
